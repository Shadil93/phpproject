...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($conn ,"INSERT INTO userregister(name,mobile,email,password,address) VALUES ('$name','$mobile','$email','$password','$address') ");


    $row = mysqli_insert_id($conn);
  
    $log = mysqli_query($conn , "INSERT INTO login(login_id,email,password,role) VALUES ('$row','$email ','$password', 0)");
