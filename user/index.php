    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <!-- <li><a class="nav-link scrollto" href="../seller/sellerregister.php">Seller Register</a></li>
          <li><a class="nav-link scrollto" href="../seller/productadd.php">product sell</a></li>-->
